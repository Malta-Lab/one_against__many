...
# Train
CUDA_VISIBLE_DEVICES=2,3 python main_multitask.py -ptm $PTM --batch_size 12 --gpus 2 --prefix \
...
# Train
CUDA_VISIBLE_DEVICES=2,3 python main_multitask.py -ptm $PTM --batch_size 10 --gpus 2 --prefix \
--tasks codesearch code2test clone concode defect refine translate summarization -i 10000 \
--cs_lang javascript ruby go java python php --sum_lang javascript ruby go java python php \
--output_dir $EXP_NAME
...
# Train
CUDA_VISIBLE_DEVICES=0,1 python main_multitask.py -ptm $PTM --batch_size 10 --gpus 2 --prefix \
--tasks codesearch code2test clone concode defect refine translate summarization -i 10000 \
--cs_lang javascript ruby go java python php --sum_lang javascript ruby go java python php \
--output_dir $EXP_NAME

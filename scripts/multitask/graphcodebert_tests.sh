...
# EXP_NAME="one_take_10k_iters_with_summarization"
...
# EXP_NAME="one_take_10k_iters_without_summarization"
# PTM="microsoft/graphcodebert-base"
# PTM_NAME="microsoft-graphcodebert-base"
# CHECKPOINT_PATH="/home/parraga/projects/_masters/multitask_code/checkpoints/multitask/${EXP_NAME}/${PTM_NAME}/best_model.ckpt"
...
# EXP_NAME="one_take_10k_iters_same_as_original_1gpu"
# PTM="microsoft/graphcodebert-base"
# PTM_NAME="microsoft-graphcodebert-base"
# CHECKPOINT_PATH="/home/parraga/projects/_masters/multitask_code/checkpoints/multitask/${EXP_NAME}/${PTM_NAME}/best_model.ckpt"

# # Train
# CUDA_VISIBLE_DEVICES=0 python main_multitask.py -ptm $PTM --batch_size 10 --gpus 1 --prefix \
# --tasks codesearch code2test clone generation defect refine translate -i 10000 \
# --cs_lang javascript ruby go java python php --sum_lang javascript ruby go java python php \
# --output_dir $EXP_NAME
...
# EXP_NAME="one_take_100k_iters_2gpu"
# PTM="microsoft/graphcodebert-base"
# PTM_NAME="microsoft-graphcodebert-base"
# CHECKPOINT_PATH="/home/parraga/projects/_masters/multitask_code/checkpoints/multitask/${EXP_NAME}/${PTM_NAME}/best_model.ckpt"
